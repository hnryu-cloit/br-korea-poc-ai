...
from services.rag_service import KnowledgeDocument, Base
...
def generate_insights():
    ...
    # 전체 33개 점포이므로 모두 가져옴
    try:
        stor_df = pd.read_sql('SELECT DISTINCT "MASKED_STOR_CD", "MAKED_STOR_NM" FROM "STOR_MST" WHERE "MASKED_STOR_CD" IS NOT NULL LIMIT 33', engine)
