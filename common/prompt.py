...
SALES_ANALYSIS_PROMPT_TEMPLATE = """
        ...
        응답 조건:
        1. "text": 질의에 대한 자연스럽고 통찰력 있는 요약 설명.
        2. "evidence": 분석의 근거가 되는 구체적인 데이터 포인트들 (리스트 형태).
        3. "actions": 점주가 즉시 실행할 수 있는 액션 아이템들 (리스트 형태).
        4. "sources": 데이터의 출처 (예: "매장 매출 마트", "재고 이력 DB", "운영 가이드북").
        5. "visual_data": 수치를 직관적으로 보여줄 수 있는 차트 정보. 
           형식 예시: {{"type": "bar", "labels": ["전주", "금주"], "datasets": [{{ "label": "매출액", "data": [120, 150] }}]}}
